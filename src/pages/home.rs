    ...
    fn create(_: Self::Properties, link: ComponentLink<Self>) -> Self {
        let products: Vec<Product> = vec![
            Product {
                ...
                image: "https://i.pinimg.com/originals/03/52/63/03526336ef23211c5a4c91db0ff12d17.png".to_string(),
                price: 3.65,
            },
            Product {
                id: 2,
                ...
                image: "https://pngimg.com/uploads/banana/banana_PNG835.png".to_string(),
                price: 7.99,
            },
        ];
    ...
    fn view(&self) -> Html {
        let products: Vec<Html> = self
            ...
            .map(|product: &Product| {
                ...
                html! {
                    <div>
                        <img style="height: 100px; width: 100px;" src={&product.image}/>
        ...
        let cart: Vec<Html> = self
            .state
            .cart_products
            .iter()
            .map(|cart_product: &CartProduct| {
                html! {
                    <li>{&cart_product.product.name}</li>
                }
            }).collect();
